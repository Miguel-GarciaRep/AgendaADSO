...
// Función auxiliar: crea una promesa que se resuelve después de "ms" milisegundos
function delay(ms) {
...
function FormularioContacto({ onAgregar }) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // Esperamos 4 segundos (4000 ms) antes de continuar,
      // sin afectar el resto del flujo del formulario
      await delay(4000);
