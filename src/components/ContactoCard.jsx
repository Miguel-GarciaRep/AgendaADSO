function ContactoCard({ id, nombre, telefono, correo, etiqueta, onEliminar, onEditar, index = 0 }) {
    ...
    >
      <div className="flex justify-between items-start gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-shrink-0 w-full sm:w-auto justify-end">
          <button
            onClick={() => onEditar({ id, nombre, telefono, correo, etiqueta })}
            className="bg-indigo-50 hover:bg-indigo-100 text-indigo-600 px-3 py-2 rounded-xl font-medium transition-all duration-200 hover:text-indigo-700 flex items-center gap-1.5"
          ...
          <button
            ...
            className="bg-red-50 hover:bg-red-100 text-red-600 px-3 py-2 rounded-xl font-medium transition-all duration-200 hover:text-red-700 flex items-center gap-1.5"
